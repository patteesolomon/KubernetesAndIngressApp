...
open the folder you downloaded from mediafire. extract that file into your new folder. Open that project file within the file base at the root of the project folder using Android Studio.
